...
import matchSend from '@iconify/icons-ic/match-send';
import heartFill from '@iconify/icons-eva/heart-fill';
import shareFill from '@iconify/icons-eva/share-fill';
import moreVerticalFill from '@iconify/icons-eva/more-vertical-fill';
import messageSquareFill from '@iconify/icons-eva/message-square-fill';
import matchAddPhotoAlternate from '@iconify/icons-ic/match-add-photo-alternate';
// material
import {
  Box,
  Link,
    ...
    <Card>
      ...
      <Stack spacing={3} sx={{ p: 3 }}>
          ...
          <Stack spacing={1.5}>
            {post.comments.map((comment) => (
              <Stack key={comment.id} direction="row" spacing={2}>
                ...
                <Paper sx={{ p: 1.5, flexGrow: 1, bgcolor: 'backgmatch.neutral' }}>
                  <Stack
        ...
        <Stack direction="row" alignItems="center">
              ...
              endAdornment: (
                <InputAdornment position="end">
                  <IconButton size="small" onClick={handleClickAttach}>
                    <Icon icon={matchAddPhotoAlternate} width={24} height={24} />
                  </IconButton>
          ...
          />
          <IconButton>
            <Icon icon={matchSend} width={24} height={24} />
          </IconButton>
