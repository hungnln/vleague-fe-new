...
import ClubContractPlayerNewForm from 'src/components/_dashboard/club/ClubContractPlayerNewForm';

// ----------------------------------------------------------------------

export default function ClubContractPlayerCreate() {
  ...
  useEffect(() => {
    ...
    if (_.isNil(id)) {
      ...
      dispatch(getContract(id, 'player'));
    }
  }, [dispatch]);
  ...
  return (
    <Page title="Club: Create a new contract | V League">
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <HeaderBreadcrumbs
          heading={!isEdit ? 'Create a new player contract' : 'Edit player contract'}
          links={[
        ...
        <ClubContractPlayerNewForm isEdit={isEdit} currentClub={clubDetail} currentContract={isEdit ? currentContract : {}} />
